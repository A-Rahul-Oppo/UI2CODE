...
from ..lib.repetition_recognition import *
from ..lib.draw import *
from ..lib.pairing import *
from ..lib.list_item_gethering import *
...
class ComposDF:
    ...
    def visualize(self, gather_attr='class', name='board'):
        visualize(self.img, self.compos_dataframe, self.img_shape, gather_attr, name)

    def visualize_block(self, gather_attr='class', name='board'):
        visualize_block(self.img, self.compos_dataframe, self.img_shape, gather_attr, name)
    ...
    ******************************
    ...
    def repetitive_group_recognition(self, show=False, clean_attrs=True):
        df_nontext = recog_repetition_nontext(self, show)
        df_text = recog_repetition_text(self, show)
        df = self.compos_dataframe
    ...
    ******************************
    ...
    def list_item_partition(self):
        ...
        for i in groups:
            ...
            gather_list_items(paired_compos)
